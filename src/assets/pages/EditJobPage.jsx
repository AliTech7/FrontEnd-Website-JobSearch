...
const EditJobPage = ({updateJobSubmit}) => {
  const job = useLoaderData(); // Assuming this fetches the job data
  ...
  return (
    <div className="bg-gradient-to-r from-gray-400 to-gray-600 min-h-screen py-10 flex items-center justify-center">
      <div className="w-full max-w-4xl mx-auto bg-white shadow-2xl rounded-lg p-8">
        <h1 className="text-4xl font-bold text-center text-gray-900 mb-10">Edit Job</h1>
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <label className="block text-gray-700 font-semibold mb-2" htmlFor="type">Job Type</label>
            <select
              id="type"
              className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500"
              value={type}
          ...
          <div>
            <label className="block text-gray-700 font-semibold mb-2" htmlFor="salary">Salary (MAD)</label>
            <select
  id="salary"
  className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500"
  value={salary}
...
>
  ...
  <option value="100K MAD+">100K MAD+</option>
          ...
          <div>
            <label className="block text-gray-700 font-semibold mb-2" htmlFor="companyDescription">Company Description</label>
            <textarea
          ...
          <div>
            <label className="block text-gray-700 font-semibold mb-2" htmlFor="contactPhone">Contact Phone</label>
            <input
              type="tel"
              id="contactPhone"
              className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500"
